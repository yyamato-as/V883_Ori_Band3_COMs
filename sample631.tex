...
\startdata
CH$_3$OH & \multirow{15}{*}{$100.4_{-2.8}^{+2.7}$} & \multirow{15}{*}{$0.48_{-0.01}^{+0.01}$} & $2.91_{-0.24}^{+0.29} \times 10^{18}$ \\
CH$_3$OCHO & & & $5.36_{-0.15}^{+0.15} \times 10^{17}$ \\
CH$_3$CHO & & & $3.74_{-0.18}^{+0.21} \times 10^{17}$ \\
CH$_3$OCH$_3$ & & & $5.13_{-0.30}^{+0.31} \times 10^{17}$ \\
CH$_3$COCH$_3$ & & & $3.23_{-0.25}^{+0.26} \times 10^{16}$ \\
$c$-C$_2$H$_4$O & & & $3.91_{-0.28}^{+0.31} \times 10^{16}$ \\
$t$-C$_2$H$_3$CHO & & & $4.34_{-0.19}^{+0.20} \times 10^{15}$ \\
$s$-C$_2$H$_5$CHO & & & $1.75_{-0.16}^{+0.16} \times 10^{16}$ \\
CH$_2$DOH & & & $2.11_{-0.23}^{+0.24} \times 10^{16}$ \\
CH$_3$O$^{13}$CHO & & & $2.99_{-0.23}^{+0.23} \times 10^{16}$ \\
CH$_3^{13}$CHO & & & $7.70_{-1.10}^{+1.14} \times 10^{16}$ \\
CH$_2$DCHO & & & $1.65_{-0.33}^{+0.35} \times 10^{16}$ \\
CH$_3$CDO & & & $6.61_{-0.75}^{+0.77} \times 10^{15}$ \\
C$_2$H$_3$CN & & & $1.92_{-0.39}^{+0.41} \times 10^{15}$ \\
SO$_2$ & & & $1.70_{-0.30}^{+0.31} \times 10^{16}$
\enddata
\tablenotetext{\dagger}{Uncertainties are the 16th and 84th percentile of the posterior distributions, where only the statistical uncertainty is included.}
\label{tab:specfit_result}
\end{deluxetable}
