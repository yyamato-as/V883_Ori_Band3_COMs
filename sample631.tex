...
We also examined the channel map of the COM emission in Band 3 in Figure \ref{fig} to search for the potential signals from the cavity region. Assuming that the COM gas follows the Keplerian rotation, the high-velocity components purely traces the emission from the inner region.  
