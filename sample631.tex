...
\plotone{12C13C}
\caption{Posterior probability density distributions of $^{12}$C/$^{13}$C ratios of \acetaldehyde, \methylformate, and \dimethylether. Two isomers of $^{13}$C-isotopologues are observed for \acetaldehyde and \methylformate. The probability density is normalized by the total probability being unity. The ISM value of 69 is marked by the vertical dashed line.}
\label{fig:12C13C}
\end{figure}
...
While the detected numbers and abundances of O-bearing COMs in V883 are comparable to those in protostellar cores, N-bearing COMs seem to be deficient in V883 ori compared with those in protostellar coers. In the present observations, 
...
In V883 ori, \citet{Lee2019} reported the detection of CH$_3$SH and tentative detection of SO$_2$. The present observations have confirmed SO$_2$ and newly detected OCS.
