...
\title{ALMA Band 3 Observations of Complex Organic Molecules in the V883 Ori disk}
...
Our Solar System has formed from its protoplanetary disk, or the proto-solar disk, a byproduct of the formation of the Sun via the gravitational collapse of the parental molecular cloud. Observations have found many volatile ices in Solar System comets, which should hold information about the chemical composition of the solar nebula, suggesting that the proto-solar disk was rich in volatile such as water and organics. Organic molecules are of particular interests as they could be the precursor of the pre-biotic molecules, which may be the origins of life on Earth \citep{Ceccarelli2023}.

The origin of the cometary water and organics has been extensively discussed, but it is still under debate. The possibility that has been most frequently discussed is that the cometary ices are, at least partially, inherited from the interstellar medium (ISM) through the formation of the Solar System. The high D/H ratio of water observed in a protoplanetary disk, which shows a similar value to those in protostellar envelopes and comets, strongly suggests the inheritance of water from the ISM rather than the chemical reset (e.g., destruction and reformation of water) in the disk \citep{Tobin2023}. Organic molecules have also been detected in protostellar envelopes and Solar System comets \citep[e.g.,][]{Jorgensen2016, Rubin2019}. In the warm inner envelopes heated by the central protostar, organic molecules are thermally desorbed at a typical sublimation temperature of $\sim100$\,K, allowing us to observe molecules sublimated from ices. Among these molecules, carbon-bearing molecules with six or more atoms are empirically called as complex organic molecules (COMs). The composition of COMs in protostellar envelopes is compared to that in comets, from which the potential inheritance of COMs from the prestellar and protostellar phases are discussed \citep[e.g.,][]{Drozdovskaya2019}.

Observations of COMs in protoplanetary disks are, however, rather sparse compared to those in protostellar envelopes since COMs are mainly locked into ices due to its colder nature ($<100$\,K) in the bulk of the observable regions of typical disks around T Tauri stars. Relatively simple organic molecules such as \methanol, CH$_3$CN, and HCOOH, which are non-thermally desorbed and/or formed via gas-phase chemistry in the outer cold region, are detected in a handful of disks \citep{Walsh2016, Oberg2015, Bergner2018, Loomis2018, Ilee2021, Favre2018}, but those observations do not directly trace the bulk composition of COMs hidden in the ice mantles. Recently, high-sensitivity observations with Atacama Large Millimeter/submillimeter Array (ALMA) have just begun to detect the emission of thermally desorbed COMs in warm disks around Herbig Ae/Be stars \citep{vanderMarel2021, Booth2021_CH3OH, Brunken2022, Booth2023_HD169142}, but the detections are still limited in a few numbers of disks and molecular species. As the protoplanetary disks could be potential sites for the chemical reset from the ISM \citep[e.g,][]{Walsh2014, Furuya2014}, constraining the composition and distribution of COMs in disks is crucial to fully track the chemical evolution during star and planet formation.

Recent observations of the disk around the young outbursting star, V883 Ori, opened a new window to COMs in protoplanetary disks. V883 Ori is a low-mass ($M_\star = 1.3\,M_\odot$; \citealt{Cieza2016}) FU Orionis type object located in the L1641 cluster in the  Orion molecular clouds \citep[$d\approx400$\,pc;][]{Strom1993}, which shows a large-amplitude outburst in the optical ($\Delta m_\mathrm{V} > 4$\,mag) with an increased luminosity of $\sim200\,L_\odot$ \citep{Furlan2016}. This high luminosity warms the disk and shifts the sublimation front (or snowline) of COMs, making it possible to observe the thermally desorbed molecules in the disk. In addition, as the typical duration of the outburst ($\sim10^2$\,yr) is shorter than the timescale of the typical gas-phase chemical reaction (several $10^4$\,yr; e.g., \citealt{Nomura2009}), it is possible to observe the flesh sublimates without any chemical alternation in gas phase and almost directly probe the composition of disk ices. 
...
\citet{vantHoff2018} detected \methanol emission for the first time in this disk with high-resolution ($\sim0\farcs14$) ALMA Band 7 observations, followed by the additional detection of several COMs such as \methylformate, \acetaldehyde, and CH$_3$CN in ALMA Band 7 at $\sim0\farcs1$ resolution \citep{Lee2019}. These COM emissions all show the velocity structure consistent with the Keplerian rotation traced by the C$^{18}$O emission \citep{Cieza2016, vantHoff2018}, evidencing that the COM emission originates from the rotationally-supported disk. The COM emission spreads over 40--120 au radii with an inner emission cavity, similar to the spatial distribution of the water emission \citep{Tobin2023}. \citet{Lee2019} compared the relative abundances of a few COMs with respect to \methanol, the simplest COM, to those in warm envelopes of the Class 0 protostar IRAS~16293-2422~B \citep[hereafter IRAS~16293B; e.g.,][]{Jorgensen2016} and the Solar System comet 67P/Churyumov-Gerasimenko \citep[hereafter 67P/C-G; e.g.,][]{Altwegg2019}. They found that the abundances of COMs in the V883 Ori disk are generally higher than those in IRAS~16293B (except for CH$_3$CN) and similar to in 67P/C-G, implying potential chemical evolution in protoplanetary disks.

However, these observations still have several limitations. First, in ALMA Band 7, i.e., the sub-mm wavelengths, the intense dust continuum emission hides the molecular line emission in the innermost region ($\lesssim40$\,au radius), which results in an apparent inner cavity in the molecular line emission \citep{vantHoff2018, Lee2019, Tobin2023}. This prevents us from studying the chemical composition of COMs there, i.e., the comet- and terrestrial-planet-forming zone, which can be directly compared to the measurements in comets and planetary atmospheres in our Solar System. Second, the limited number of unambiguously detected species \citep{Lee2019} makes it difficult to derive a general and concrete picture of chemical evolution in protoplanetary disks. Third, previous observations do not succeeded in measuring the isotopic ratios (e.g., $^{12}$C/$^{13}$C and D/H) of COMs \citep[except for the D/H ratio of \methanol;][]{Lee2019, Lee2023}, the most sensitive chemical fingerprint to trace the formation conditions and thermal histories.

In this paper, we present the new observations of COMs toward the V883 Ori disk in ALMA Band 3 where the dust continuum emission is expected to be fainter than the sub-mm wavelength thanks to the lower opacity of dust grains in longer wavelengths. Observational and imaging details are described in Section \ref{sec:observation}, followed by a detailed analysis of the disk-integrated spectra in Section \ref{sec:analysis_result}, reporting the first detection of several species including $^{13}$C- and D-isotopologues. We discuss the implications of the present observations for the physical and chemical structure of the V883 Ori disk, as well as the chemical composition and isotopic chemistry of COMs in protoplanetary disks in Section \ref{sec:discussion}. We finally summarize the present work in Section \ref{sec:summary}.
...
As the emission is only marginally spatially resolved, we assumed that the emitting region in Band 3 is the same as that of \methanol in Band 6 \citep{Tobin2023}. The inner and outer radius of the emitting area is fixed to 0\farcs1 and 0\farcs3, respectively. 
...
CH$_3$OH & \multirow{21}{*}{$106.7_{-3.8}^{+4.3}$} & \multirow{21}{*}{$0.71_{-0.05}^{+0.08}$} & $3.81_{-0.58}^{+0.73} \times 10^{18}$ \\ 
...
To fully reveal the emission distribution and COM chemistry in the innermost region of the V883 Ori disk, we need higher-resolution observations in Band 3 (and further longer wavelength such as Band 1 and VLA/ngVLA) and the detailed combined analysis of the line and continuum emission.
...
Another possible explanation for the inner depression of the COM emission is that the molecules inside 40 au are destroyed by the strong UV/X-ray radiation from the central protostar. The UV radiation can destroy COMs via photodissociation \citep[e.g.,][]{Garrod2006, Oberg2009}. However, such UV effect will be generally effective only in lowest density regions (such as outflow inner cavities and disk upper surfaces) because of the 
extinction by dust emission.
In contrast, X-ray radiation can penetrate into higher density region than UV radiation.
Recently, \citet{Notsu2021} modeled the effect of the X-ray radiation from the central protostar on the chemistry of the protostellar envelopes, and found that the gas-phase fractional abundances of \methanol and other COMs decrease within their snowlines as the X-ray luminosity of the central protostar increases. In the presence of the strong X-ray radiation, COMs are mainly destroyed by the X-ray-induced photodissociation \citep[e.g.,][]{Garrod2006, Taquet2016, Notsu2021}. While the efficiency of the destruction of the molecules could be lower in higher-density disks than the lower-density envelopes \citep{Notsu2021}, a similar mechanism may work in the innermost region of the V883 Ori disk, where the X-ray/UV luminosity can also be increased due to the outburst of the central star, in particular in the low-density disk surface.
We note that \citet{Kuhn2019} reported that X-ray luminosities and plasma temperature of X-ray radiation in FU Ori type stars tend to be larger than in typical non-bursting YSOs, based on the comparison to a sample of low-mass stars in the Orion Nebula Cluster.
In addition, cosmic-rays accelerated close to the central star (in strong magnetized shocks along the outflow or in accretion shocks near the stellar surface) could penetrate into the higher-density disk midplane and causes the destruction of COMs via cosmic-ray-induced photodissociation \citep[e.g.,][]{Padovani2020, Cabedo2023}.
...
\end{align}
These reactions can contribute to the efficient formation of these species in protoplanetary disks \citep{Walsh2014, Furuya2014}, which can be the origin of abundant complex species in the V883 Ori disk (Figure \ref{fig:ratio_comparison}).
...
\textbf{\citet{Lee2019} also detected several species presented in Figure \ref{fig:ratio_comparison} in ALMA Band 7 observations. Figure \ref{} compared the abundance ratios with respect to \methanol in our observations to those presented in \citet{Lee2019}.} 
...
We note that gas-phase C/O ratio and elemental C/H gas abundance become lower as ionization rate in the disk becomes larger (such as $\gtrsim10^{-17}$ s$^{-1}$) \citep[e.g.,][]{Eistrup2016, Schwarz2018, Notsu2020}, which might inhibit the increase of $^{13}$CO abundance via the exchange reaction (Equation \ref{eq:12C13C_reaction}) \citep{Woods2009}. Alternatively, it may also be possible that the destruction of carbonaceous grains can enhance the C/H abundance and C/O ratio in protostellar disks and envelopes \citep[e.g.,][]{Wei2019, vantHoff2020}, although it is unclear whether the destruction of carbonaceous grains efficiently occurs in the outer region where CO and COMs form ($\lesssim100$ K).

In the comet 67P/Churyumov-Gerasimenko, only \methanol/$^{13}$CH$_3$OH ratio has been measured ($91\pm10$) and it shows no $^{13}$C fractionation (Table \ref{tab:12C13C_summary}; \citealt{Altwegg2020_isotopes}). $^{12}$C/$^{13}$C ratios of simpler molecular species such as CO, CO$_2$, and H$_2$CO have also been measured, but no $^{13}$C fractionation has been observed \citep{Hassig2017, Rubin2017} except for H$_2$CO ($40\pm14$; \citealt{Altwegg2020_isotopes}). This trend is in contrast to the observed $^{13}$C fractionation for different COM species in the V883 Ori disk. Although the origin of this difference is unclear, one speculative explanation might be the formation environment of the comet 67P; it may be formed from the dust grains with non-$^{13}$C-rich ices, which can be produced from lower gas-phase C/O ratios ($< 1$). \citet{Yoshida2022_12CO13CO} reported a radial variation in the gas-phase $^{12}$CO/$^{13}$CO ratio in the disk around TW~Hya, where the outer region ($>130$ au) shows a higher $^{12}$CO/$^{13}$CO ratio ($>84$) than that in the inner region (70--110 au; $21\pm5$). If a similar radial variance in the $^{12}$CO/$^{13}$CO ratio existed in the presolar disk, the $^{13}$C fractionation in comets depends on the formation location within the disk.
...
\tablehead{\colhead{} & \colhead{V883 Ori (this work)$^\dagger$} & \colhead{IRAS 16293-2422 A\tablenotemark{a}} & \colhead{IRAS 16293-2422 B\tablenotemark{b}} & \colhead{67P/Churyumov-Gerasimenko\tablenotemark{c}}}
\startdata
Methanol & & & \\
...
The CH$_2$DOH/\methanol ratio is slightly lower than the typical values observed in the warm protostellar envelopes ($\sim$ 0.01--0.1; e.g., \citealt{Jorgensen2018, Taquet2019, Drozdovskaya2021}).  The lower value may point to the formation at warmer condition than in prestellar cores. e.g., in protoplanetary disks. Although methanol is considered to form on surface of cold dust grains in cold prestellar cores, and be delivered to protoplanetary disks, it can be destroyed by the UV/X-ray radiation and/or energetic particles such as cosmic rays from the central star (see Section \ref{subsec:physicochemical_structure} and \citealt{Notsu2021}) and reform on the dust grain surfaces in disks. As the D/H ratios are very sensitive to the formation temperature, the slightly lower D/H ratio of \methanol in the V883 Ori disk may be explained by the reformation of \methanol on warmer dust grain surfaces. The upper limits on the D/H ratios of \methylformate are also lower by a factor of $\sim3$ compared to those in IRAS 16293-2422 B ($\sim0.06$; \citealt{Jorgensen2018}), which may also point to the (re-)formation in warmer conditions.

In the comet 67P, D/H ratio of \methanol (not the column density ratio, but the elemental D/H ratio after the statistical correction) has been measured to be 0.71--6.6~\% \citep{Drozdovskaya2021}, which reduced to a CH$_2$DOH/CH$_3$OH ratio (0.021--0.20) similar to the values in the warm protostellar envelopes, pointing to the prestellar origins of \methanol in the comet 67P \citep{Drozdovskaya2021}. The CH$_2$DOH/\methanol ratio in the V883 Ori disk ($0.0057_{-0.0015}^{+0.0018}$) is smaller than the value in the comet 67P by a factor of $\sim$ 3--4. This might suggest the different origins of \methanol in the comet 67P and the V883 Ori disk; while \methanol in the V883 Ori disk may have experienced the destruction and reformation on the lukewarm ($\gtrsim30-50$ K) dust grain surfaces in the inner region of the disk, the comet 67P might be formed in the cold ($\sim10$ K) outer region of the presolar disk, where molecules are directly inherited from the natal envelope without significant chemical alternation. In addition, it may also be possible that the efficiency of \methanol destruction varies between the outbursting V883 Ori disk and the presolar disk, potentially due to the different X-ray/UV/cosmic-ray fluxes from the central star (\citealt{Notsu2021}, see also Section \ref{subsec:physicochemical_structure}).
...
%%
S.N.~is grateful for support from RIKEN Special Postdoctoral Researcher Program (Fellowships), Grants-in-Aid for JSPS  (Japan Society for the Promotion of Science) Fellows Grant Number JP23KJ0329, and MEXT/JSPS Grants-in-Aid for Scientific Research (KAKENHI) Grant Numbers JP20K22376, JP20H05845, JP20H05847, and JP23K13155.
%%
\end{acknowledgments}
...
\section{Reconstruction of Radial Intensity Profile}
...
\begin{equation}
    I_{r_i}(v) = \int_{\Omega_\mathrm{annulus}}I_{r_i}\exp\left[- \frac{(v - v_\mathrm{kep}(r, \theta) - v_\mathrm{sys})^2}{2\sigma_v^2}\right]d\Omega,
\end{equation}
where $\Omega_\mathrm{annulus}$ is the solid angle of the annulus, $I_{r_i}$ is the surface brightness (in Jy au$^{-2}$ km s$^{-1}$) at the radius of $r_i$
