...
\subsection{The physical and chemical structure of the innermost region of the V883 Ori disk}
...
\begin{align}
    \mathrm{HCO} + \mathrm{CH_3} &\longrightarrow \mathrm{CH_3CHO}, \\
    \mathrm{HCO} + \mathrm{CH_3O} &\longrightarrow \mathrm{CH_3OCHO}, \\
    \mathrm{CH_3} + \mathrm{CH_3O} &\longrightarrow \mathrm{CH_3OCH_3}, \\
    \mathrm{CH_3} + \mathrm{CH_3CO} &\longrightarrow \mathrm{CH_3COCH_3}.
\end{align}
...
\subsubsection{Carbon isotope fractionation}
\subsubsection{Deuterium fractionation}
